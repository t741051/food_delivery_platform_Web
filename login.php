	...
	<body>
		...
		<?php 
			...
			if(isset($_POST['submit'])){
				...
				//1. Get the Data from form     輸入的帳號 密碼
                ...
                $sql = "SELECT id, password FROM manage_admin where id = '$user_id' and password = '$password'";
                ...
                if ( $account_exist < 1 ) {
                    ...
                    $_SESSION['id'] = (string)$user_id;
                    
					if(strpos($_SESSION['id'],'rest_') !== false){ 
						echo '<Script language="JavaScript"> 
						location.href = "restaurant_index.php";
						</Script>';
					}elseif(strpos($_SESSION['id'],'deli_') !== false){
						echo '<Script language="JavaScript"> 
						location.href = "deliveryman_index.php";
						</Script>';
					}else{
						echo '<Script language="JavaScript"> 
