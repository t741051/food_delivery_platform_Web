									...
									while($rows = mysqli_fetch_assoc($res)){
											?>											
												<tr>
													...
													<td><?php echo $rows['order_status_text'];?></td>
													<td>													
														<a href="update_order.php?order_id=<?php echo $rows['order_id']; ?>" class="btn">變更</a>
													</td>	
													<td>
														<a href="delete_order.php?order_id=<?php echo $rows['order_id']; ?>" class="btn">刪除</a>
													</td>
												</tr>
											<?php										
									}
