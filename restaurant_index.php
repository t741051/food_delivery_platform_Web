	        ...
	        <div class='container'>
				<nav class="navbar navbar-expand-lg navbar-light">
				  ...
				  <div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<a class="nav-link" href="restaurant_dashboard.php">		<!-- 右上角使用者登入 -->			
						<?php 
							if(isset($_SESSION['id'])){
								echo '使用者名稱(商家端) : ' . $_SESSION['id'];
							}					
						?>
					</a>					
		...
		<section id='intro'>
			...
			<div class="jumbotron">
			  <div class='container'>
				  <div class='row'>
					  <div class='col-md-12'>						  
						  <h1 class="display-4">美食外送 商家端</h1>
					  ...
					  <div class='col-md-12 text-center'>
					  	...
					  	<div class='row'>
						  	<div class='col-md-4 text-left'>
							  	<div class='outer'>
								  	<a href='http://localhost/test_food_order/restaurant_manage.php'>
									  	<div class='upper'>
						  	...
						  	<div class='col-md-4 text-left'>
							  	<div class='outer'>
								  	<a href='http://localhost/test_food_order/restaurant_dashboard.php'>
										<div class='upper'>
						  	...
						  	<div class='col-md-4 text-left'>
							  	<div class='outer'>
								  	<a href='http://localhost/test_food_order/restaurant_add.php'>
										<div class='upper'>
