			...
			<form action="" method="POST">
				...
				<table class="table">
					<tr>
						<td>餐點名稱: </td>
						<td>
							<input type="text" name="food_name" placeholder="餐點名稱">
						</td>
					</tr>					
					<tr>
						<td>價格: </td>
                    ...
                    <tr>
						<td>種類: </td>
						<td>
							<input type="text" name="food_category" placeholder="種類">
						</td>
					</tr>
                    <tr>
						<td>備註: </td>
				...
				<?php 
					...
					if(isset($_POST['submit'])){
                        ...
                        $food_id = file_get_contents($restaurant_id . "_food_id.txt");
				        file_put_contents($restaurant_id . "_food_id.txt", ((int)$food_id) + 1 );
						...
						if ( $food_exist < 1 ) {
							...
							$sql = "INSERT INTO food_attribute SET 
