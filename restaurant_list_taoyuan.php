...
<html>
	...
	<body>
        ...
        <section id='intro'>
			...
			<div class="jumbotron_Taoyuan">
			  <div class='container'>
				  <div class='row'>
					  <div class='col-md-12'>						  
						  <h1 class="display-4">桃園 Taoyuan</h1>						  
					  </div>
				  </div>
			  </div>
			</div>
                                                ...
                                                <div class='col-md-4 text-left'>
                                                    <div class='outer'>
														<form  method="POST" action="">  
															<a href="restaurant_menu_taoyuan.php?restaurant_id=<?php echo $rows['restaurant_id']; ?>" >
																<div class='upper'>
																	<img src='pictures/restaurant_taoyuan_<?php echo $picture_num?>.jpg'>											
