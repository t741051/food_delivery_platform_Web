        ...
        <section id='intro'>
			...
			<div class="jumbotron_Taipei">
			  <div class='container'>
				  <div class='row'>
					  <div class='col-md-12'>						  
						  <h1 class="display-4">台北 Taipei</h1>						  
					  </div>
				  </div>
			  </div>
			</div>
                                                ...
                                                <div class='col-md-4 text-left'>
                                                    <div class='outer'>
														<form  method="POST" action="">  
															<a href="restaurant_menu_taipei.php?restaurant_id=<?php echo $rows['restaurant_id']; ?>" >
																<div class='upper'>
																	<img src='pictures/restaurant_taipei_<?php echo $picture_num?>.jpg'>											
