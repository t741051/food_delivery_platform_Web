				...
				<nav class="navbar navbar-expand-lg navbar-light">
				  ...
				  <div class="collapse navbar-collapse" id="navbarSupportedContent">
				    <ul class="navbar-nav mr-auto">
				      ...
				      <li class="nav-item">
				        <a class="nav-link" href="http://localhost/test_food_order/search_restaurant.php">搜尋店家</a>
				      </li>	
				      <li class="nav-item">
		...
		<section id='intro'>
			...
			<div class="jumbotron">
			  <div class='container'>
				  <div class='row'>
					  <div class='col-md-12'>						  
						  <h1 class="display-4">美食外送</h1>
						  <p class="lead">把您喜愛的美食親手外送給您！</p>
					  ...
					  <div class='col-md-12 text-center'>
					  	...
					  	<div class='row'>
						  	<div class='col-md-4 text-left'>
							  	<div class='outer'>
								  	<a href='http://localhost/test_food_order/restaurant_list_taipei.php'>
									  	<div class='upper'>
											<img src='pictures/Taipei.jpg'>											
									  	</div>
									  	<div class='lower'>
										  	<h3>台北</h3>
									  	</div>
						  	...
						  	<div class='col-md-4 text-left'>
							  	<div class='outer'>
								  	<a href='http://localhost/test_food_order/restaurant_list_taoyuan.php'>
										<div class='upper'>
											<img src='pictures/Taoyuan.jpg'>
									  	</div>
									  	<div class='lower'>
										  	<h3>桃園</h3>
									  	</div>
						  	...
						  	<div class='col-md-4 text-left'>
							  	<div class='outer'>
								  	<a href='http://localhost/test_food_order/restaurant_list_hsinchu.php'>
										<div class='upper'>
											<img src='pictures/Hsinchu.jpg'>
									  	</div>
									  	<div class='lower'>  
										  	<h3>新竹</h3>
									  	</div>
